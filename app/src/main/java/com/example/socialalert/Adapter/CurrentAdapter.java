...
/**
 * Created by sagar on 1/5/17.
 */

public class CurrentAdapter extends RecyclerView.Adapter<CurrentAdapter.MyViewHolderClass>{

    List<AlertData> dataArray = Collections.emptyList();
    Context context;

    public CurrentAdapter(List<AlertData> dataArray) {
